...
3. Treat the authorized Phase 1 work order as the corpus-selection authorization once the manifest is recorded; create a new Architect-review gate only for a material corpus change.
