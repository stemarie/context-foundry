...
- Return exactly PASS, REQUEST_CHANGES, or BLOCKED. Evidence is mandatory for every verdict; use REQUEST_CHANGES for ordinary nonconformance and reserve BLOCKED for last-resort unsafe continuation.
